...
public class C02_ManageMethods {
    public static void main(String[] args) throws InterruptedException {
        ...
        if (actulaTitle.equals(expectedTitle)){
            ...
            System.out.println("TEST FAILED Gerçek Başlık : "+actulaTitle);
        ...
        if (actuallTitle.contains(istenenKelime)){
            ...
            System.out.println("TEST FAILED Gerçek Başlıl = "+actuallTitle);
        ...
        if (gercekUrl.equals(istenenUrl)){
            ...
            System.out.println("TEST FAILED Gerçek Url = "+gercekUrl);
